...
- [Obsidian Fountain plugin](https://github.com/bgrundmann/obsidian-fountain)
  - newer plugin, different philosophy
  - turns Obsidian into a pure Fountain writing app, instead of hybrid with markdown
  - has index cards, readonly view, export to PDF
